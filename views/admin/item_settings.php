...
?>
 ...
 <div class="mmth-item-settings-builder-area">
		    ...
		    <div class="themehunk-megamenu-draggable-widgets-list">
		        ...
		        if ( count( $widgets ) ){
		            foreach ($widgets as $key => $value){ ?>
		                <div class="draggable-widget" data-widget-id-base="<?php echo esc_attr($value['id_base']);?>" data-type="outside-widget">
		                	<span class="outside-widget-name">
		                	<?php echo esc_html($value['name']);?>
		                	</span>
		                	<span class="widgets-drag-btn"><i class="fa fa-arrows"></i>
		                	<?php echo __('Drag', 'themehunk-megamenu');?></span>
		                	</div>
		           <?php }
		        }
		       ?>
 	...
 	<div class="themehunk-megamenu-builder-content-wrapper">
 		...
 		<?php if ( $menu_item_depth == 0 ) { ?>
		<h3 class="activate-megamenu-msg" style="<?php echo esc_attr( ( $themehunk_megamenu_item_megamenu_status == 'active' ) ? 'display: none;' : '' ); ?>">	
 			<?php _e( 'Please activate MegaMenu for this menu item.', 'themehunk-megamenu' ) ?>	
 		</h3>		
 		<div class="themehunk-megamenu-builder-content" style="<?php echo esc_attr( ( $themehunk_megamenu_item_megamenu_status == 'inactive' ) ? 'display: none;' : '' ); ?>">
			            ...
			            <?php  
	                      ...
	                      if ( isset($themehunk_megamenu_layout['layout']) ){ 
	                            foreach ($themehunk_megamenu_layout['layout'] as $layout_key => $layout_value){ ?>
	                                <div class="themehunk-megamenu-row" data-row-id="<?php echo esc_attr($layout_key); ?>">
	                            ...
	                            <?php
	                                foreach ($layout_value['row'] as $col_key => $layout_col){ ?>
	                                  ...
	                                  <div class="themehunk-megamenu-col themehunk-megamenu-col-<?php echo esc_attr($layout_col['col']); ?> " data-col-id="<?php echo esc_attr($col_key); ?>">
						...
						<table>
						  <tr>
						    ...
						    <td class="mmth-sett-optn">
						    	...
						    	<input type="text" name="themehunk_megamenu_width" 
									value="<?php echo isset($mmth_builder_option['themehunk_megamenu_width']) ? esc_attr($mmth_builder_option['themehunk_megamenu_width']) : '100%'; ?>" 
									placeholder="Enter width (e.g., 100%, 50px)">
						    </td>
						  </tr>
						  <tr>
						  <!-- chk box -->
						  ...
						  <td class="mmth-sett-optn">
						  <input type="checkbox" id="themehunk_megamenu_endtoend" name="themehunk_megamenu_endtoend" value="end-to-end" 
                          <?php checked( isset( $mmth_builder_option['themehunk_megamenu_endtoend'] ) && $mmth_builder_option['themehunk_megamenu_endtoend'] === 'end-to-end' ); ?> />
						  </td>
						</tr>
						  <!-- radio image -->
						  <tr>
						  	...
						  	<td class="mmth-sett-optn">
						  		<label class="themehunk-megamenu-pannel-alignment">
									<div class="mmth-radio-selector">
										...
										<label class="radio-cc <?php echo esc_attr( $panel_alignment === 'panleft' ? 'active' : '' ); ?>" style="background-image: url(<?php echo esc_url( THEMEHUNK_MEGAMENU_PANEL_LEFT ); ?>);" for="panleft"></label>

									    <input id="panright" type="radio" name="themehunk-megamenu-pannel-alignment" value="panright" />
									    
										<label class="radio-cc <?php echo esc_attr( isset( $mmth_builder_option['mmth_pannel_alignment'] ) && $mmth_builder_option['mmth_pannel_alignment'] === 'panright' ? 'active' : '' ); ?>" 
											style="background-image: url(<?php echo esc_url( THEMEHUNK_MEGAMENU_PANEL_RIGHT ); ?>);" 
											for="panright"></label>
						  ...
						  <tr>
							  ...
							  <input type="text" id="item-megamenu-bgimage-url" name="themehunk_megamenu_bg_image" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_bg_image'] ) ? $mmth_builder_option['themehunk_megamenu_bg_image'] : '' ); ?>">
						  		...
						  		<p class="hide-if-no-js <?php echo esc_attr($hidden); ?>">
						  			<span class="img-ovrlay">
									  <img id="item-megamenu-bgimage-container" 
										src="<?php echo esc_url( isset( $mmth_builder_option['themehunk_megamenu_bg_image'] ) ? $mmth_builder_option['themehunk_megamenu_bg_image'] : '' ); ?>" 
										alt="<?php esc_attr_e( 'MegaMenu Background Image', 'themehunk-megamenu' ); ?>" />
									</span><br>
						    ...
						    <tr>
						  	...
						  	<td class="mmth-sett-optn">
						  		<label class="mmth-mega-bg-color">
									  ...
									  <input type="text" class="color_picker_megamenu" name="themehunk_megamenu_bg_color" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_bg_color'] ) ? $mmth_builder_option['themehunk_megamenu_bg_color'] : '#fff' ); ?>" 
       style="background: <?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_bg_color'] ) ? $mmth_builder_option['themehunk_megamenu_bg_color'] : '#fff' ); ?>" />
						  ...
						  <tr>
						  	...
						  	<td class="mmth-sett-optn">
						  		<label class="mmth-mega-pannel-top-padding">
						  			...
						  			<input class="themehunk_megamenu_mega_pannel_padding_top mmth-padding" 
       type="number" 
       name="themehunk_megamenu_mega_pannel_padding_top" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_pannel_padding_top'] ) ? $mmth_builder_option['themehunk_megamenu_mega_pannel_padding_top'] : '' ); ?>">


						  		</label>
						  		<label class="mmth-mega-pannel-right-padding">
						  			<span class="mega-short-desc"><?php  _e('Right', 'themehunk-megamenu');?></span>
						  			<input class="themehunk_megamenu_mega_pannel_padding_right mmth-padding" 
       type="number" 
       name="themehunk_megamenu_mega_pannel_padding_right" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_pannel_padding_right'] ) ? $mmth_builder_option['themehunk_megamenu_mega_pannel_padding_right'] : '' ); ?>">


						  		</label>
						  		<label class="mmth-mega-pannel-bottom-padding">
						  			<span class="mega-short-desc"><?php  _e('Bottom', 'themehunk-megamenu');?></span>
									  <input class="themehunk_megamenu_mega_pannel_padding_bottom mmth-padding" 
       type="number" 
       name="themehunk_megamenu_mega_pannel_padding_bottom" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_pannel_padding_bottom'] ) ? $mmth_builder_option['themehunk_megamenu_mega_pannel_padding_bottom'] : '' ); ?>">


						  		</label>
						  		<label class="mmth-mega-pannel-left-padding">
						  			<span class="mega-short-desc"><?php  _e('Left', 'themehunk-megamenu');?> </span>
									  <input class="themehunk_megamenu_mega_pannel_padding_left mmth-padding" 
       type="number" 
       name="themehunk_megamenu_mega_pannel_padding_left" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_pannel_padding_left'] ) ? $mmth_builder_option['themehunk_megamenu_mega_pannel_padding_left'] : '' ); ?>">
						  ...
						  <tr>
						  	...
						  	<td class="mmth-sett-optn">
						  		<label class="mmth-mega-border-color">
						  			<span class="mega-short-desc"><?php  _e('Color', 'themehunk-megamenu');?></span>
						  			<input type="text" class="color_picker_megamenu" 
       name="themehunk_megamenu_border_color" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_border_color'] ) ? $mmth_builder_option['themehunk_megamenu_border_color'] : '#fff' ); ?>" 
       style="background: <?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_border_color'] ) ? $mmth_builder_option['themehunk_megamenu_border_color'] : '#fff' ); ?>" />

						  		</label>
						 
						  		<label class="mmth-mega-pannel-top-border">
						  			<span class="mega-short-desc"><?php  _e('Top', 'themehunk-megamenu');?></span>
						  			<input class="themehunk_megamenu_mega_pannel_border_top mmth-border" 
       type="number" 
       name="themehunk_megamenu_mega_pannel_border_top" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_pannel_border_top'] ) ? $mmth_builder_option['themehunk_megamenu_mega_pannel_border_top'] : '' ); ?>">


						  		</label>
						  		<label class="mmth-mega-pannel-right-border">
						  			<span class="mega-short-desc"><?php  _e('Right', 'themehunk-megamenu');?></span>
						  			<input class="themehunk_megamenu_mega_pannel_border_right mmth-border" 
       type="number" 
       name="themehunk_megamenu_mega_pannel_border_right" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_pannel_border_right'] ) ? $mmth_builder_option['themehunk_megamenu_mega_pannel_border_right'] : '' ); ?>">


						  		</label>
						  		<label class="mmth-mega-pannel-bottom-border">
						  			<span class="mega-short-desc"><?php  _e('Bottom', 'themehunk-megamenu');?></span>
									  <input class="themehunk_megamenu_mega_pannel_border_bottom mmth-border" 
       type="number" 
       name="themehunk_megamenu_mega_pannel_border_bottom" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_pannel_border_bottom'] ) ? $mmth_builder_option['themehunk_megamenu_mega_pannel_border_bottom'] : '' ); ?>">


						  		</label>
						  		<label class="mmth-mega-pannel-left-border">
						  			<span class="mega-short-desc"><?php  _e('Left', 'themehunk-megamenu');?> </span>
						  			<input class="themehunk_megamenu_mega_pannel_border_left mmth-border" 
       type="number" 
       name="themehunk_megamenu_mega_pannel_border_left" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_pannel_border_left'] ) ? $mmth_builder_option['themehunk_megamenu_mega_pannel_border_left'] : '' ); ?>">
						  ...
						  <tr>
						  	...
						  	<td class="mmth-sett-optn">
						  		<label class="mmth-mega-pannel-top-left-radius">
						  			<span class="mega-short-desc"><?php  _e('Top', 'themehunk-megamenu');?></span>
						  			<input class="themehunk_megamenu_mega_pannel_raidus_top_left mmth-padding" 
       type="number" 
       name="themehunk_megamenu_mega_pannel_raidus_top_left" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_pannel_raidus_top_left'] ) ? $mmth_builder_option['themehunk_megamenu_mega_pannel_raidus_top_left'] : '' ); ?>">


						  		</label>
						  		<label class="mmth-mega-pannel-top-right-radius">
						  			<span class="mega-short-desc"><?php  _e('Right', 'themehunk-megamenu');?></span>
						  			<input class="themehunk_megamenu_mega_pannel_raidus_top_right mmth-padding" 
       type="number" 
       name="themehunk_megamenu_mega_pannel_raidus_top_right" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_pannel_raidus_top_right'] ) ? $mmth_builder_option['themehunk_megamenu_mega_pannel_raidus_top_right'] : '' ); ?>">


						  		</label>
						  		<label class="mmth-mega-pannel-bottom-right-radius">
						  			<span class="mega-short-desc"><?php  _e('Bottom', 'themehunk-megamenu');?></span>
									  <input class="themehunk_megamenu_mega_pannel_raidus_bottom_right mmth-padding" 
       type="number" 
       name="themehunk_megamenu_mega_pannel_raidus_bottom_right" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_pannel_raidus_bottom_right'] ) ? $mmth_builder_option['themehunk_megamenu_mega_pannel_raidus_bottom_right'] : '' ); ?>">


						  		</label>
						  		<label class="mmth-mega-pannel-bottom-left-radius">
						  			<span class="mega-short-desc"><?php  _e('Left', 'themehunk-megamenu');?> </span>
						  			<input class="themehunk_megamenu_mega_pannel_raidus_bottom_left mmth-padding" 
       type="number" 
       name="themehunk_megamenu_mega_pannel_raidus_bottom_left" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_pannel_raidus_bottom_left'] ) ? $mmth_builder_option['themehunk_megamenu_mega_pannel_raidus_bottom_left'] : '' ); ?>">
						  ...
						  <tr>
						  	...
						  	<td class="mmth-sett-optn">
						  		<label class="mmth-mega-column-top-padding">
						  			<span class="mega-short-desc"><?php  _e('Top', 'themehunk-megamenu');?></span>
						  			<input class="themehunk_megamenu_mega_column_padding_top mmth-padding" 
       type="number" 
       name="themehunk_megamenu_mega_column_padding_top" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_column_padding_top'] ) ? $mmth_builder_option['themehunk_megamenu_mega_column_padding_top'] : '' ); ?>">


						  		</label>
						  		<label class="mmth-mega-column-right-padding">
						  			<span class="mega-short-desc"><?php  _e('Right (px)', 'themehunk-megamenu');?></span>
						  			<input class="themehunk_megamenu_mega_column_padding_right mmth-padding" 
       type="number" 
       name="themehunk_megamenu_mega_column_padding_right" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_column_padding_right'] ) ? $mmth_builder_option['themehunk_megamenu_mega_column_padding_right'] : '' ); ?>">


						  		</label>
						  		<label class="mmth-mega-column-bottom-padding">
						  			<span class="mega-short-desc"><?php  _e('Bottom', 'themehunk-megamenu');?></span>
									  <input class="themehunk_megamenu_mega_column_padding_bottom mmth-padding" 
       type="number" 
       name="themehunk_megamenu_mega_column_padding_bottom" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_column_padding_bottom'] ) ? $mmth_builder_option['themehunk_megamenu_mega_column_padding_bottom'] : '' ); ?>">


						  		</label>
						  		<label class="mmth-mega-column-left-padding">
						  			<span class="mega-short-desc"><?php  _e('Left', 'themehunk-megamenu');?> </span>
						  			<input class="themehunk_megamenu_mega_column_padding_left mmth-padding" 
       type="number" 
       name="themehunk_megamenu_mega_column_padding_left" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_mega_column_padding_left'] ) ? $mmth_builder_option['themehunk_megamenu_mega_column_padding_left'] : '' ); ?>">
						  ...
						  <tr>
						  	...
						  	<td class="mmth-sett-optn">
						  		<label class="mmth-mega-widget-title-color">
									  ...
									  <input type="text" 
       class="color_picker_megamenu" 
       name="themehunk_megamenu_themehunk_megamenu_widget_title_color" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_themehunk_megamenu_widget_title_color'] ) ? $mmth_builder_option['themehunk_megamenu_themehunk_megamenu_widget_title_color'] : '#000' ); ?>" 
       style="background: <?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_themehunk_megamenu_widget_title_color'] ) ? $mmth_builder_option['themehunk_megamenu_themehunk_megamenu_widget_title_color'] : '#000' ); ?>" />
						  	   ...
						  	   <label class="mmth-mega-widget-text-color">
									  ...
									  <input type="text" 
       class="color_picker_megamenu" 
       name="themehunk_megamenu_megamenu_widget_text_color" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_megamenu_widget_text_color'] ) ? $mmth_builder_option['themehunk_megamenu_megamenu_widget_text_color'] : '#000' ); ?>" 
       style="background: <?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_megamenu_widget_text_color'] ) ? $mmth_builder_option['themehunk_megamenu_megamenu_widget_text_color'] : '#000' ); ?>" />
						  	   ...
						  	   <label class="mmth-mega-widget-link-color">
									  ...
									  <input type="text" 
       class="color_picker_megamenu" 
       name="themehunk_megamenu_megamenu_widget_link_color" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_megamenu_widget_link_color'] ) ? $mmth_builder_option['themehunk_megamenu_megamenu_widget_link_color'] : '#000' ); ?>" 
       style="background: <?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_megamenu_widget_link_color'] ) ? $mmth_builder_option['themehunk_megamenu_megamenu_widget_link_color'] : '#000' ); ?>" />
						  	   ...
						  	   <label class="mmth-mega-widget-linkhvr-color">
									  ...
									  <input type="text" 
       class="color_picker_megamenu" 
       name="themehunk_megamenu_megamenu_widget_linkhvr_color" 
       value="<?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_megamenu_widget_linkhvr_color'] ) ? $mmth_builder_option['themehunk_megamenu_megamenu_widget_linkhvr_color'] : '#000' ); ?>" 
       style="background: <?php echo esc_attr( isset( $mmth_builder_option['themehunk_megamenu_megamenu_widget_linkhvr_color'] ) ? $mmth_builder_option['themehunk_megamenu_megamenu_widget_linkhvr_color'] : '#000' ); ?>" />
